...
def craiglockhart_and_tollcross
  ...
  join
    routes b ON a.company = b.company AND a.num = b.num
  join
    stops astops ON astops.id = a.stop_id
  join
    stops bstops ON bstops.id = b.stop_id
  WHERE
    astops.name = 'Craiglockhart' AND bstops.name = 'Tollcross'
  GROUP BY
    a.company, a.num
  SQL
end
...
def craiglockhart_to_sighthill
  ...
  execute(<<-SQL)
  SELECT
    a.num, a.company, cstops.name, b.num, b.company
  FROM
    routes a
  join
    routes b ON a.company = b.company AND a.num = b.num
  ...
  join
    stops cstops ON cstops.id = a.stop_id
  join
    stops astops ON astops.id = a.stop_id
  join
    stops bstops ON bstops.id = b.stop_id
  where
    astops.name = 'Craiglockhart' --AND bstops.name = 'Sighthill'
  GROUP BY
    a.num, a.company, cstops.name, b.num, b.company
  SQL
end
